    ...
    <div class="site-sidebar__inner">
      ...
      >
        ...
        <el-submenu index="demo" v-if="false">
          ...
          <el-menu-item index="demo-avue" @click="$router.push({ name: 'demo-avue' })">
            <icon-svg name="editor" class="site-sidebar__menu-icon"></icon-svg>
            <span slot="title">avue</span>
          </el-menu-item>
          <el-menu-item index="demo-avue1" @click="$router.push({ name: 'demo-avue1' })">
            <icon-svg name="editor" class="site-sidebar__menu-icon"></icon-svg>
            <span slot="title">avue1</span>
          </el-menu-item>
          <el-menu-item index="demo-avue2" @click="$router.push({ name: 'demo-avue2' })">
            <icon-svg name="editor" class="site-sidebar__menu-icon"></icon-svg>
